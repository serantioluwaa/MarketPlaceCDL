  ...
  return (
    <div class="boss">
      <div className="min-h-full flex flex-col justify-center py-10 sm:px-6 lg:px-8 ">
        <div className="sm:mx-auto sm:w-full sm:max-w-md space-y-5  ">
          ...
          <div className="bg-white py-8 px-4 shadow-2xl sm:rounded-lg sm:px-16 w-auto ">
            <h2 className="mt-6 text-center text-xl font-extrabold text-black">
              Start Selling on CDL MarketHub
            </h2>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md space-y-3">
              <form className="space-y-6" action="#" method="POST" onSubmit={submitHandler}>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Sign Up Now
                  </button>
                </div>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                  <div>
                    <a
                      href="#"
                      className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-blue-500 hover:bg-gray-300"
                    >
        ...
        <div class="beneath">
          Already a seller?
          <a href="#" className="font-medium text-blue-500 hover:text-blue-800">
            {' '}
            Login
          </a>
        </div>
