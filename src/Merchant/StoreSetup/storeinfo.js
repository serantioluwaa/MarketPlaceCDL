              ...
              <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md space-y-3">
                <form className="space-y-6" action="#" method="POST">
                  ...
                  <div class="space-y-14">
                    ...
                    <option>Food, Health & Beauty Supplements</option>
                    <option>Jewelry</option>
                    <option>Mobile Phones</option>
                    <option>Fashion Accessories</option>
                    <option>Home Decor Items</option>
                    <option>Kitchen Ware and Household Appliances</option>
                    <option>Toys and games</option>
                    <option>Sports good and Fitness Equipment</option>
                    <option>Provisions</option>
                    <option>Computer Hardware, Software, and Accessories</option>
                    </select>
                    </div>
                    </div>
