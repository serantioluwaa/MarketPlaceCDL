            ...
            <div className="bg-white py-8 px-4 shadow-2xl sm:rounded-lg sm:px-16 w-auto ">
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                <h3 className="font-medium text-slate-600 ">
                  {" "}
                  Take another look at your entries before submitting{" "}
                </h3>
              </p>
              <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md space-y-3">
                ...
                <div class="divide-y-2 ">
                  ...
                  <button class="text-blue-700"> Edit </button>
                    ...
                    <div className="mt-1 col-auto space-y-2">
                    <div>Store Name.</div>
                  ...
                  >
                  {" "}
                  Business Informtation
                  </label>
                  <button class="text-blue-700"> Edit </button>
                  </div>
                    <div className="mt-1 col-auto space-y-2">
                    <div>Company registered name</div>
                    <div>Address</div>
                    <div>CAC Registration Number</div>
                    <div>Upload a copy of the CAC Certificate</div>
                    <div>Email</div>
                    </div>
                  </div>
                  ...
                  <button class="text-blue-700"> Edit </button>
                    ...
                    <div class="flex justify-between">
                    <div>
                    By submitting, you confirm that the details you are providing are correct.
                    </div>
                    <button
                    type="submit"
